...
메인 키워드: ${keyword}
핵심 키워드: 메인쿤분양, 메인쿤분양가, 메인쿤크기, 메인쿤성격, 메인쿤키우기, 메인쿤입양, 메인쿤무료분양, 메인쿤특징, 메인스테이
${kakaoLine}
...
4) 분양 중인 아이 사진은 메인스테이 메인 갤러리에서 볼 수 있음
5) 문의 방법 — 본문 마지막에만, 짧게

아래 JSON만 출력. 설명·마크다운 금지.

{
  "title": "55자 내. '{keyword}' 포함. 예: '{keyword} | 메인스테이 메인쿤분양'",
  "metaDescription": "140~158자. '{keyword}', 메인쿤분양, 메인쿤크기. 전화번호 금지",
  "metaKeywords": "{keyword}, 메인쿤분양, 메인쿤분양가, 메인쿤크기, 메인쿤성격, 메인스테이 등 10~14개",
  "h1": "'{keyword}'와 '메인쿤분양' 또는 '입양'이 들어간 H1",
  "heroSubtitle": "한글 한 문장. 분양 안내 + 사진",
  "heroBadge": "분양 안내",
  "heroTitleLine2": "메인스테이",
  "heroBar": "집에서 키울 때의 크기·성격·분양가를 먼저 맞춰 보세요.",
  "sections": [
  ...
  "faqs": [
    ...
    {"q": "분양 중인 아이는 사진을 볼 수 있나요?", "a": "80자+. 메인스테이 메인 갤러리 안내"}
  ],
...
> {
  ...
  return {
    keyword,
    title: String(data.title || `${keyword} | 메인스테이 메인쿤분양`),
    metaDescription: clampDesc(data.metaDescription || SITE.description),
    metaKeywords: String(
      data.metaKeywords ||
        `${keyword}, 메인쿤분양, 메인쿤분양가, 메인쿤크기, 메인쿤성격, 메인스테이`
    ),
    ...
    heroTitleLine2: String(data.heroTitleLine2 || "메인스테이"),
...
export function assembleSeoPage(
  ...
  return {
    ...
    heroTitleLine2: partial.heroTitleLine2 || "메인스테이",
