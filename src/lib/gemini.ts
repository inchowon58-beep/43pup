...
{
  "title": "55자 내. '{keyword}' 포함. 예: '{keyword} | 퍼피두들 미니두들분양'",
  "metaDescription": "140~158자. '{keyword}', 미니두들분양, 골든두들분양. 전화번호 금지",
  "metaKeywords": "{keyword}, 미니두들분양, 골든두들분양, 골든두들분양가, 골든두들키우기 등 10~14개",
  "h1": "'{keyword}'와 '미니두들분양' 또는 '입양'이 들어간 H1",
...
AEO: FAQ는 실제 검색 질문처럼. 본문에 '{keyword}'와 '미니두들'을 자연스럽게 반복.`;
}
...
> {
  ...
  return {
    keyword,
    title: String(data.title || `${keyword} | 퍼피두들 미니두들분양`),
    metaDescription: clampDesc(data.metaDescription || SITE.description),
    metaKeywords: String(
      data.metaKeywords ||
        `${keyword}, 미니두들분양, 골든두들분양, 골든두들분양가, 골든두들키우기, 퍼피두들`
    ),
    h1: String(data.h1 || `${keyword}, 미니두들분양 안내`),
    heroSubtitle: String(
      data.heroSubtitle || "미니두들분양·골든두들분양 사진을 보고 크기를 정해 보세요"
    ),
    heroBadge: String(data.heroBadge || "분양 안내"),
    heroTitleLine1: keyword,
    heroTitleLine2: String(data.heroTitleLine2 || "퍼피두들"),
    heroBar: String(data.heroBar || "미니두들분양·골든두들분양 사진을 보고 크기를 정해 보세요."),
    sections,
    faqs,
...
export function assembleSeoPage(
  ...
  return {
    ...
    heroTitleLine2: partial.heroTitleLine2 || "퍼피두들",
    heroBar: partial.heroBar || "미니두들분양·골든두들분양 사진을 보고 크기를 정해 보세요.",
