...
/** 히어로·소개·특징 카드 */
export const FEATURE_FILES = [28, 14, 2, 9, 17, 35, 11, 36] as const;

/** 갤러리 상단 큰 사진 두 장 — 순서 변경 */
export const GALLERY_FEATURED = [5, 22] as const;

/** 갤러리 본문 12장 */
export const GALLERY_GRID = [6, 8, 11, 13, 18, 19, 20, 23, 27, 33, 36, 40] as const;
