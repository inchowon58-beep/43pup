...
/** 메인·AEO용 자주 묻는 질문 — 미니두들 분양 */
export const HOME_FAQS: FaqItem[] = [
  {
    q: "미니두들은 어떤 성격인가요?",
    a: "사람을 잘 따르고 온순한 편입니다. 아이·가족과 함께 지내기 좋아, 첫 반려견으로 많이 찾습니다. 개체마다 차이는 있어 상담 때 지금 만날 수 있는 아이 성격을 함께 안내합니다.",
  },
  {
    q: "털이 많이 빠지나요?",
  ...
  {
    q: "아파트에서도 키울 수 있나요?",
    a: "미니·미디엄은 실내 생활이 가능한 경우가 많습니다. 산책과 사람과의 시간이 중요하니, 생활 패턴을 알려 주시면 맞는 아이를 안내합니다.",
  },
  {
    q: "두들 분양 비용은 얼마인가요?",
  ...
  },
  {
    ...
    a: `네. 메인 갤러리에서 분양 중인 미니두들 사진을 보실 수 있습니다. 마음에 남는 아이가 있으면 카카오톡으로 물어보세요. ${KAKAO_CTA_HINT}`,
  },
  {
    q: "상담은 어디로 하면 되나요?",
...
export const EMERGENCY_HOWTO_STEPS = [
  {
    name: "분양 사진을 먼저 봅니다",
    text: "갤러리에서 미니두들 모습을 확인합니다. 마음에 남는 아이가 있으면 메모해 두세요.",
  },
  {
    name: "원하는 조건을 알려 줍니다",
