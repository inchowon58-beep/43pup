...
export const HOME_FAQS: FaqItem[] = [
  {
    q: "메인쿤은 어떤 성격인가요?",
    a: "사람을 잘 따르고 온순한 대형묘입니다. 아이·가족과 함께 지내기 좋아, 첫 고양이로도 많이 찾습니다. 개체마다 차이는 있어 상담 때 지금 만날 수 있는 아이 성격을 함께 안내합니다.",
  },
  {
    q: "털 관리가 많이 필요하나요?",
    a: "장모라 정기 빗질이 필요합니다. 귀 끝 링스 팁과 풍성한 코트를 유지하려면 브러시 주기를 지켜 주시면 더 고와집니다.",
  },
  {
    q: "아파트에서도 키울 수 있나요?",
    a: "실내 생활이 가능한 경우가 많습니다. 다만 체구가 커서 이동 공간과 캣타워를 넉넉히 두는 것이 좋습니다. 생활 패턴을 알려 주시면 맞는 아이를 안내합니다.",
  },
  {
    q: "메인쿤 분양 비용은 얼마인가요?",
...
export function howToJsonLd(pageUrl?: string) {
  return {
    ...
    description:
      "분양 사진 보기, 상담, 방문, 집으로 맞이하기까지 메인쿤 입양 안내.",
    inLanguage: "ko-KR",
    totalTime: "PT2H",
...
export function orgJsonLd(url?: string, telephone?: string) {
  return {
    ...
    "@type": "LocalBusiness",
    name: SITE.name,
    alternateName: [SITE.brand, SITE.brandEn, "메인쿤분양", "메인쿤분양 쿠니네"],
