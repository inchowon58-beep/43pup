...
export default function AdminClient() {
  ...
  const [keyword, setKeyword] = useState("버니두들분양");
  ...
  function absolutePageUrl(path: string) {
    const base = (process.env.NEXT_PUBLIC_SITE_URL || "https://doodlekorea.puppytimes.co.kr").replace(
      /\/$/,
      ""
    );
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-4 rounded-xl border border-white bg-white/90 p-4 text-sm text-[var(--ink)] shadow-sm">
                  ...
                  <ol className="mt-2 list-decimal space-y-2 pl-5 leading-relaxed">
                    <li>
                      ...
                      <br />
                      <span className="text-[var(--muted)]">이름 예: 장례정보센터 문의알림</span>
                    </li>
                    <li>
                      그룹에 <b>본인</b> + <b>운영자</b> + 봇
                      <code className="mx-1 rounded bg-[var(--sky-soft)] px-1.5 py-0.5 text-xs">
                        @{telegramStatus?.botUsername || "petfuneral_bot"}
                      </code>
                      를 초대합니다.
                    </li>
                    <li>
                      그룹에서 봇에게 <code className="rounded bg-[var(--sky-soft)] px-1.5 py-0.5 text-xs">/start</code> 를
                    ...
                    <li>
                      Vercel 프로젝트 Environment Variables에서
                      <br />
                      <code className="rounded bg-[var(--coral-soft)] px-1.5 py-0.5 text-xs font-bold">
                        TELEGRAM_CHAT_ID
                      </code>
                      를 <b>그룹 ID</b>로 바꾸거나,
                      <br />
                      개인+운영자 각각이면{" "}
                      <code className="rounded bg-[var(--coral-soft)] px-1.5 py-0.5 text-xs">
                        8433555162,운영자ID
                      </code>{" "}
                      처럼 쉼표로 넣습니다.
                    </li>
                  ...
                  <p className="mt-3 rounded-lg bg-[var(--sky-soft)] px-3 py-2 text-xs text-[var(--sky-deep)]">
                ...
                <div className="mt-3 flex flex-wrap gap-2 text-xs">
                  ...
                  <span className="rounded-full bg-white px-3 py-1 font-semibold text-[var(--navy)] ring-1 ring-[var(--line)]">
                    봇: @{telegramStatus?.botUsername || "petfuneral_bot"}
                  </span>
                  <span className="rounded-full bg-white px-3 py-1 font-semibold text-[var(--navy)] ring-1 ring-[var(--line)]">
