    ...
    <section id="process" className="section">
      <div className="container">
        <div className="mx-auto max-w-2xl text-center">
          <p className="section-kicker">HOW WE OPEN THE DOOR</p>
        ...
        <div className="relative mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {STEPS.map((s) => (
            <div key={s.n} className="relative text-center lg:pt-0">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[var(--navy)] text-lg font-bold text-[#f4eadc]">
                {s.n}
              </div>
