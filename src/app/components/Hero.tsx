    ...
    <section id="top" className="relative min-h-[92svh] overflow-hidden">
      <div className="absolute inset-0 hero-media">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(47,93,80,0.38)_0%,rgba(47,93,80,0.16)_38%,rgba(30,42,36,0.82)_100%)]" />
      </div>

      <div className="container relative flex min-h-[92svh] flex-col justify-end pb-28 pt-28 md:pb-24">
        <div className="animate-rise max-w-2xl">
          <p className="text-xs font-semibold tracking-[0.22em] text-[#f3c9a3]">
            {SITE.taglineEn}
          </p>
          ...
          <p className="mt-4 max-w-xl text-xs leading-relaxed text-[#f8eadf] md:text-sm">
            {KEYWORD_INQUIRY}
          </p>
