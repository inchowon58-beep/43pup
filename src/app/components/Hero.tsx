    ...
    <section id="top" className="relative min-h-[92svh] overflow-hidden">
      <div className="absolute inset-0 hero-media">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(26,39,68,0.52)_0%,rgba(26,39,68,0.18)_38%,rgba(18,24,42,0.92)_100%)]" />
      </div>

      <div className="container relative flex min-h-[92svh] flex-col justify-end pb-28 pt-28 md:pb-24">
        <div className="animate-rise max-w-2xl">
          <p className="text-xs font-semibold tracking-[0.22em] text-[#d4c4b0]">
            {SITE.taglineEn}
          </p>
          ...
          <p className="mt-4 max-w-xl text-xs leading-relaxed text-[#f6ebe3] md:text-sm">
            {KEYWORD_INQUIRY}
          </p>
