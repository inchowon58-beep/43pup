...
export default function GuideHeroThumb({ page, imageSrc }: Props) {
  ...
  const line2 = page.heroTitleLine2 || "우리 집의 두들";
  const bar =
    page.heroBar || page.heroSubtitle || "분양 중인 골든두들 사진을 보고 마음을 정해 보세요";

  return (
    <div className="relative mx-auto aspect-square w-full max-w-[720px] overflow-hidden rounded-[1.6rem] shadow-[0_18px_44px_rgba(224,122,61,0.28)] ring-1 ring-[#e07a3d]/30">
      <Image
        src={imageSrc}
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(47,38,28,0.12)_0%,rgba(47,38,28,0.62)_100%)]" />
      ...
      <div className="absolute inset-0 flex flex-col items-start justify-end px-7 pb-8 text-left md:px-10 md:pb-10">
        ...
        <h1 className="mt-4 max-w-[16ch] text-[clamp(1.7rem,6vw,2.9rem)] font-bold leading-[1.25] text-white drop-shadow-[0_3px_10px_rgba(0,0,0,0.4)]">
          ...
          <span className="mt-1 block text-[#f4c9a0]">{line2}</span>
        </h1>
