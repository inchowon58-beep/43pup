...
export default function GuideHeroThumb({ page, imageSrc }: Props) {
  ...
  const line2 = page.heroTitleLine2 || "쿠니네";
  const bar =
    page.heroBar || page.heroSubtitle || "메인쿤분양 사진을 보고 성격을 정해 보세요";

  return (
    <div className="relative mx-auto aspect-square w-full max-w-[720px] overflow-hidden rounded-[1.75rem] shadow-[0_18px_44px_rgba(31,58,46,0.22)] ring-1 ring-[#c4783a]/35">
      <Image
        src={imageSrc}
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(31,58,46,0.12)_0%,rgba(20,32,26,0.62)_100%)]" />
