...
export default function DoodleGalleryCta({ className = "" }: { className?: string }) {
  return (
    <div className={`my-8 rounded-[1.4rem] border border-[var(--coral)] bg-[var(--coral-soft)] p-5 text-center md:p-6 ${className}`}>
      ...
      <a href="/#gallery" className="btn-primary mt-4 inline-flex">
        <Camera size={18} />
        {CTA_GALLERY}
      </a>
    </div>
