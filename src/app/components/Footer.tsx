...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#161412] py-12 text-[#f3eee6]">
      <div className="container grid gap-8 md:grid-cols-[1.2fr_1fr]">
        <div>
          <Link href="/" className="inline-block">
            <p className="text-xs font-semibold tracking-[0.2em] text-[#c4a35a]">{SITE.farm}</p>
            <h2 className="mt-1 text-2xl font-bold hover:text-white">{SITE.brand}</h2>
          </Link>
          <p className="mt-3 max-w-md text-sm leading-relaxed text-[#f3eee6]/65">{SITE.tagline}</p>
        </div>

        <div className="space-y-3 text-sm text-[#f3eee6]/75">
          <a
