...
export default function Footer() {
  return (
    <footer className="border-t border-[var(--line)] bg-[#5c1a2e] py-12 text-[#fffaf6]">
      <div className="container grid gap-8 md:grid-cols-[1.2fr_1fr]">
        ...
        <div className="space-y-3 text-sm text-white/75">
          ...
          >
            <MessageCircle size={16} className="text-[#c9a07a]" />
            {CTA_KAKAO}
          </a>
          <p className="flex items-start gap-2">
            <MapPin size={16} className="mt-0.5 shrink-0 text-[#c9a07a]" />
