...
export default function Footer() {
  return (
    <footer className="border-t border-[var(--line)] bg-[#3d2f54] py-12 text-[#fffdf9]">
      <div className="container grid gap-8 md:grid-cols-[1.2fr_1fr]">
        <div>
          <Link href="/" className="inline-block">
            <p className="text-xs font-semibold tracking-[0.2em] text-[#f5d0c5]">{SITE.brandEn}</p>
        ...
        <div className="space-y-3 text-sm text-white/75">
          ...
          >
            <MessageCircle size={16} className="text-[#e07a5f]" />
            {CTA_KAKAO}
          </a>
          <p className="flex items-start gap-2">
            <MapPin size={16} className="mt-0.5 shrink-0 text-[#e07a5f]" />
