...
export default function Footer() {
  return (
    <footer className="border-t border-[var(--line)] bg-[#152238] py-12 text-[#fbf9f4]">
      <div className="container grid gap-8 md:grid-cols-[1.2fr_1fr]">
        <div>
          <Link href="/" className="inline-block">
            <p className="text-xs font-semibold tracking-[0.2em] text-[#e8d5a3]">{SITE.brandEn}</p>
        ...
        <div className="space-y-3 text-sm text-white/75">
          ...
          <p className="flex items-start gap-2">
            <MapPin size={16} className="mt-0.5 shrink-0 text-[#c9a45c]" />
