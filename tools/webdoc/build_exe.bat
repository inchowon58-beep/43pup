...
echo [2/2] 안심강아지장례식장 웹문서생성기 빌드... (--windowed: 검은 콘솔 없음)
python -m PyInstaller --noconfirm --clean --windowed --name "안심강아지장례식장웹문서생성기" ^
...
echo.
echo 완료: dist\안심강아지장례식장웹문서생성기\안심강아지장례식장웹문서생성기.exe
echo.
echo 실행 방법:
echo   1) 안심강아지장례식장_웹문서생성기_실행.bat 더블클릭
echo   2) 또는 dist\안심강아지장례식장웹문서생성기\안심강아지장례식장웹문서생성기.exe
echo.
