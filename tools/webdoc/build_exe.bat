...
echo [2/2] 더제이쿤 웹문서생성기 빌드... (--windowed: 검은 콘솔 없음)
python -m PyInstaller --noconfirm --clean --windowed --name "더제이쿤웹문서생성기" ^
...
echo.
echo 완료: dist\더제이쿤웹문서생성기\더제이쿤웹문서생성기.exe
echo.
echo 실행 방법:
echo   1) 더제이쿤_웹문서생성기_실행.bat 더블클릭
echo   2) 또는 dist\더제이쿤웹문서생성기\더제이쿤웹문서생성기.exe
echo.
