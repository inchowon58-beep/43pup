...
echo [2/2] 쿤하우스 웹문서생성기 빌드... (--windowed: 검은 콘솔 없음)
python -m PyInstaller --noconfirm --clean --windowed --name "쿤하우스웹문서생성기" ^
...
echo.
echo 완료: dist\쿤하우스웹문서생성기\쿤하우스웹문서생성기.exe
echo.
echo 실행 방법:
echo   1) 쿤하우스_웹문서생성기_실행.bat 더블클릭
echo   2) 또는 dist\쿤하우스웹문서생성기\쿤하우스웹문서생성기.exe
echo.
