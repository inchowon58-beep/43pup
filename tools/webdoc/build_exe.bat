...
echo [2/2] 퍼피두들 웹문서생성기 빌드... (--windowed: 검은 콘솔 없음)
python -m PyInstaller --noconfirm --clean --windowed --name "퍼피두들웹문서생성기" ^
...
echo.
echo 완료: dist\퍼피두들웹문서생성기\퍼피두들웹문서생성기.exe
echo.
echo 실행 방법:
echo   1) 퍼피두들_웹문서생성기_실행.bat 더블클릭
echo   2) 또는 dist\퍼피두들웹문서생성기\퍼피두들웹문서생성기.exe
echo.
